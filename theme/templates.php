...
<head>
<meta charset="utf-8">
<title>DREAMSJOB / <?php echo $title;?></title>
...
<div id="wrapper" class="home-page">
  ...
  <div style="min-height: 20px;">
        <div class="topbar navbar-fixed-top"style="background-color:#131414;padding-top:10px;">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
        ...
        <div style="min-height: 10px;padding-top:2px;">
        <div class="navbar navbar-default navbar-static-top" style="background:#F0F7D4"> 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">DREAM JOBS<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                        ...
                        <li><a data-target="#myModal" data-toggle="modal" href=""> <i class="fa fa-lock"></i> Login </a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          60,North car Street Tirunelveli<br>
           Pin-627001 Tamil Nadu.</address>
          <p>
            <i class="icon-phone"></i> Contact Number:8754190448 <br>
            <i class="icon-envelope-alt"></i> ram2001@gmail.com`
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Ramganesh 2022 All right reserved.  
            </p>
          </div>
        </div>
      </div>
