  ...
  <div class="row">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "LAST_DATE">LAST DATE</label> 
                      <div class="col-md-8">
                        <textarea class="form-control input-sm" id="LAST_DATE" name="LAST_DATE" placeholder="LastDate"   autocomplete="none"><?php echo $res->LAST_DATE ?></textarea> 
                      </div>
                    </div>
                  </div>  
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                          ...
                          <option value="None">Select</option>
                           <option <?php echo ($res->JOBTYPE=='FULLTIME') ? "SELECTED" :"" ?>>FULL TIME</option>
                           <option <?php echo ($res->JOBTYPE=='PARTTIME') ? "SELECTED" :"" ?>>PART TIME</option>
