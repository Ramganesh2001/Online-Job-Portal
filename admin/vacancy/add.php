                              ...
                              <div class="col-md-8">
                                <div class="input-group">
                                    <span class="input-group-addon"> 
                                     ...
                                     <input class="form-control input-sm date_picker" id="LAST_DATE" name="LAST_DATE" placeholder="LastDate" type="text"    value="" required  autocomplete="off">
                                </div>
                              </div>
                            </div>
                          </div>
