...
global $mydb;
 ...
 // `COMPANYID`, `CATEGORY`, `OCCUPATIONTITLE`, `REQ_NO_EMPLOYEES`, `SALARIES`, `DURATION_EMPLOYEMENT`, `QUALIFICATION_WORKEXPERIENCE`, `JOBDESCRIPTION`, `PREFEREDSEX`, `LAST_DATE`, `JOBSTATUS`, `DATEPOSTED`
...
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-6">
		<ul> 
            ...
            <li><i class="fp-ht-computer"></i>Applied for Last Date: <?php echo $job->LAST_DATE; ?></li>
        </ul>
	</div>
	<div class="col-sm-12">
		<p>Job Description : </p>   
